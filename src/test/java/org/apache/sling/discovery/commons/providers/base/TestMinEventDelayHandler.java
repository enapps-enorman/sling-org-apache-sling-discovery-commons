...
public class TestMinEventDelayHandler {
    ...
    public void testReactivate() throws Exception {
        ...
        final DummyTopologyView view2 = DummyTopologyView.clone(view1)
                .addInstance(
                        UUID.randomUUID().toString(),
                        (DefaultClusterView) view1.getLocalInstance().getClusterView(),
                        false,
                        false);
        final DummyTopologyView view3 = DummyTopologyView.clone(view1)
                .addInstance(
                        UUID.randomUUID().toString(),
                        (DefaultClusterView) view1.getLocalInstance().getClusterView(),
                        false,
    ...
    public void testLongMinDelay() throws Exception {
        ...
        view2.addInstance(
                UUID.randomUUID().toString(),
                (DefaultClusterView) view2.getLocalInstance().getClusterView(),
                false,
                false);
        logger.info("testLongMinDelay: calling handleNewView...");
