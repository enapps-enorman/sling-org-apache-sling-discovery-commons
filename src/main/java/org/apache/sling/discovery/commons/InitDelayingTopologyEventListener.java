...
public class InitDelayingTopologyEventListener implements TopologyEventListener {
    ...
    public InitDelayingTopologyEventListener(
            final long startupDelay, final TopologyEventListener delegate, final Logger loggerOrNull) {
    ...
    @Deprecated
    public InitDelayingTopologyEventListener(
            final long startupDelay, final TopologyEventListener delegate, final Scheduler scheduler) {
